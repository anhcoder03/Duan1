...
function hoadon_insert($ma_kh,$tong_tien,$ngay_mua,$ghi_chu)
{
    $sql = "INSERT INTO hoadon( ma_kh, tong_tien, ngay_mua, ghi_chu)  VALUES(?,?,?,?)";
    pdo_execute($sql,$ma_kh,$tong_tien,$ngay_mua,$ghi_chu);
}
...
function hoadon_update($ma_hd,$ma_kh,$tong_tien,$ngay_mua,$ghi_chu)
{
    $sql = "UPDATE hoadon SET ma_kh=?, tong_tien=?, ngay_mua=?, ghi_chu=? WHERE ma_hd=?";
    pdo_execute($sql,$ma_kh,$tong_tien,$ngay_mua,$ghi_chu,$ma_hd);
}
