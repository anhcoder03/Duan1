<div class="container-header">
    <div id="header">
        ...
        <div class="header-right">
            ...
            <div class="cart">
                <div class="giohang"><a class="cart-icon" href="<?= $SITE_URL ?>/cart/list-cart.php"><i
                            class="fa-solid fa-cart-shopping"></i> (<?php
    ...
    <div class="header-mb">
        <div class="header-top">
            ...
            <div class="logo">
                <a href="#"><img src="../../content/images/logo.svg" alt="" /></a>
            </div>
            <div class="header-right">
                <div class="giohang">
        ...
        <ul class="menu menu-mb" id="show-menu">
            <div class="search">
                <input type="text" class="search_control" placeholder="Tìm kiếm..." />
